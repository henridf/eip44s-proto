...
// Hash: 961ec9705538aa2274ce60bfe3b0953a1c30c33555227fe49aa92536e2bb4f53
package spec
...
func (a *ArchiveHeader) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'HeadBlockNumber'
	a.HeadBlockNumber = ssz.UnmarshallUint64(buf[0:8])

	// Field (1) 'BlockCount'
	a.BlockCount = ssz.UnmarshallUint32(buf[8:12])
...
func (a *ArchiveHeader) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
...
func (a *ArchiveBody) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'Blocks'
	{
		...
		a.Blocks = make([]*Block, num)
		err = ssz.UnmarshalDynamic(buf, num, func(indx int, buf []byte) (err error) {
			if a.Blocks[indx] == nil {
				a.Blocks[indx] = new(Block)
			}
...
func (a *ArchiveBody) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
