...
// Hash: d1eb74f5d03ce7fd6a2647a0dcf75e30e698eaaa843fa64cdcf6e3c25762184f
package spec
...
// MarshalSSZ ssz marshals the BlockArchive object
func (b *BlockArchive) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(b)
}

// MarshalSSZTo ssz marshals the BlockArchive object to a target array
func (b *BlockArchive) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(16)
...
// UnmarshalSSZ ssz unmarshals the BlockArchive object
func (b *BlockArchive) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 16 {
		return ssz.ErrSize
...
// SizeSSZ returns the ssz encoded size in bytes for the BlockArchive object
func (b *BlockArchive) SizeSSZ() (size int) {
	size = 16
...
// HashTreeRoot ssz hashes the BlockArchive object
func (b *BlockArchive) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(b)
}

// HashTreeRootWith ssz hashes the BlockArchive object with a hasher
func (b *BlockArchive) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
	...
	{
		subIndx := hh.Index()
		num := uint64(len(b.Blocks))
		if num > 1000000 {
			err = ssz.ErrIncorrectListSize
			return
		}
		for _, elem := range b.Blocks {
...
func (b *Block) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	for ii := 0; ii < len(b.Transactions); ii++ {
		if len(b.Transactions[ii]) > 1073741824 {
...
func (r *Receipt) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
...
func (l *Log) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
